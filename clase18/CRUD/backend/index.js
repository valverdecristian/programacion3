...
// dependencias: sequelize y mysql2 > npm install sequelize mysql2
...
app.use(cors());
// analiza los requuest [funcion middleware] > me llega la info en un formato y lo transformo a json
