...
/* aca lo utilizaremos para leer un JSON que contiene informacion de  concesionarias */
const fs = require("fs");
...
res.render ("main",{...})
utilizamos el motor de vistas EJS para generar una pagina HTML dinamica y
