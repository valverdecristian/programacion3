...
const autosRouter = require ("./routes/autosRouter.js");
...
// definimos EJS como el motor de vistas para reenderizar contenido dinamico
...
// iniciamos el servidor en el puerto que definimos (port)
// y mostramos un mensaje de confirmacion en la consola
app.listen (port , ()=>{
